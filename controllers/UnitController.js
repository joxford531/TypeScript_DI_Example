...
let UnitController = class UnitController {
    ...
    one(id, req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            let unit = yield this.unitSvc.getUnit(id);
...
__decorate([
    ...
    __param(0, routing_controllers_1.Param("id")), __param(1, routing_controllers_1.Req()), __param(2, routing_controllers_1.Res()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object, Object]),
    __metadata("design:returntype", Promise)
], UnitController.prototype, "one", null);
__decorate([
...
], UnitController.prototype, "config", null);
__decorate([
    routing_controllers_1.Post("/unit"),
    __param(0, routing_controllers_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UnitController.prototype, "post", null);
